...
const ID_SNAPSHOT: Record<string, number> = {
    ...
    CallExpression: 30,
    NewExpression: 31,
    StaticMemberExpression: 32,
    ComputedMemberExpression: 33,
    PrivateFieldExpression: 34,
    ChainExpression: 35,
    SequenceExpression: 36,
    ArrowFunctionExpression: 37,
    ...
    ObjectPattern: 69,
    ArrayPattern: 70,
    AssignmentPattern: 71,
    RestElement: 72,
    FormalParameter: 73,
    ImportDeclaration: 74,
    ImportSpecifier: 75,
    ImportDefaultSpecifier: 76,
    ImportNamespaceSpecifier: 77,
    ExportNamedDeclaration: 78,
    ExportSpecifier: 79,
    ExportDefaultDeclaration: 80,
    ExportAllDeclaration: 81,
    TSTypeAnnotation: 82,
    TSAnyKeyword: 83,
    TSStringKeyword: 84,
    TSNumberKeyword: 85,
    ...
    TSObjectKeyword: 89,
    TSVoidKeyword: 90,
    TSUndefinedKeyword: 91,
    TSNullKeyword: 92,
    TSNeverKeyword: 93,
    TSUnknownKeyword: 94,
    TSIntrinsicKeyword: 95,
    TSThisType: 96,
    TSTypeReference: 97,
    TSQualifiedName: 98,
    TSTypeParameterInstantiation: 99,
    TSTypeParameterDeclaration: 100,
    TSTypeParameter: 101,
    TSTupleType: 102,
    TSNamedTupleMember: 103,
    TSTypeLiteral: 104,
    TSPropertySignature: 105,
    TSMethodSignature: 106,
    TSIndexSignature: 107,
    TSCallSignatureDeclaration: 108,
    TSConstructSignatureDeclaration: 109,
    TSUnionType: 110,
    TSIntersectionType: 111,
    TSFunctionType: 112,
    TSConstructorType: 113,
    TSArrayType: 114,
    TSIndexedAccessType: 115,
    TSTypeOperator: 116,
    TSTypeQuery: 117,
    ...
    TSMappedType: 120,
    TSLiteralType: 121,
    TSTemplateLiteralType: 122,
    TSImportType: 123,
    TSInterfaceDeclaration: 124,
    TSClassImplements: 125,
    TSInterfaceHeritage: 126,
    TSTypeAliasDeclaration: 127,
    TSEnumDeclaration: 128,
    TSEnumMember: 129,
    TSAsExpression: 130,
    TSSatisfiesExpression: 131,
    TSNonNullExpression: 132,
    TSModuleDeclaration: 133,
    JSXElement: 134,
    JSXOpeningElement: 135,
    JSXClosingElement: 136,
    JSXFragment: 137,
    JSXOpeningFragment: 138,
    JSXClosingFragment: 139,
    JSXNamespacedName: 140,
    JSXMemberExpression: 141,
    JSXExpressionContainer: 142,
    JSXEmptyExpression: 143,
    JSXAttribute: 144,
    JSXSpreadAttribute: 145,
    JSXSpreadChild: 146,
    JSXIdentifier: 147,
    JSXText: 148,
...
describe('walk drift vs CHILD_FIELDS', () => {
    it('hand-switch walk visits every child field of every type, in schema order', () => {
        for (const t of interiorTypes) {
            ...
            const seen: string[] = [];
            walk(n, (c) => {
                if (c.type === N.IdentifierReference) seen.push(c.name);
            });
    ...
    it('hand-switch walk and generic walkChildren agree on visitation order', () => {
        for (const t of interiorTypes) {
            ...
            walk(n, (c) => {
                if (c.type === N.IdentifierReference) viaSwitch.push(c.name);
            });
            const viaSchema: string[] = [];
            walkChildren(n, (c) => {
                viaSchema.push(c.name);
            });
    ...
    it('enter=false skips children', () => {
        ...
        walk(n, (c) => {
            seen.push(c.name);
            return c.type === N.IfStatement ? false : undefined;
        });
        expect(seen).toEqual(['']);
    });
});
