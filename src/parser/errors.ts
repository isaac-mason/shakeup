...
export const ParseErrorCode = enumeration(
    ...
    'StringExportedBinding',
    'UnexpectedSuper',
    'ForOfAsyncLhs',
    'ForOfLetLhs',
    'InvalidNewMetaProperty',
    'UnexpectedPrivateName',
    'AssignmentNotSimple',
...
const TEMPLATE: Record<number, string> = {
    ...
    [ParseErrorCode.StringExportedBinding]: 'A string literal cannot be used as an exported binding without `from`',
    [ParseErrorCode.UnexpectedSuper]: "'super' can only be used with function calls or in property accesses",
    [ParseErrorCode.ForOfAsyncLhs]: 'The left-hand side of a `for...of` statement may not be `async`',
    [ParseErrorCode.ForOfLetLhs]: 'The left-hand side of a `for...of` statement may not start with `let`',
    [ParseErrorCode.InvalidNewMetaProperty]: 'The only valid meta property for new is new.target',
    [ParseErrorCode.UnexpectedPrivateName]: 'Unexpected private identifier',
