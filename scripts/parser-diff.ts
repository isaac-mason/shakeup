...
const CASES: Case[] = [
    ...
    { name: 'unicode escape in continue position', src: 'var a\\u0062c = 1;' },
    { name: 'unicode escape, `\\u{}` form', src: 'var \\u{61}bc = 1;' },
    { name: 'unicode escape in a member name', src: 'o.\\u0061;' },
    { name: 'unicode escape in a property key', src: 'var x = { \\u0061: 1 };' },
    { name: 'unicode escape in a label', src: 'label\\u0031: for (;;) break label1;' },
    { name: 'invalid: escaped identifier starting with a digit', src: 'var \\u0031 = 1;' },
    { name: 'invalid: escaped surrogate pair', src: 'var \\uD83D\\uDE00 = 1;' },
